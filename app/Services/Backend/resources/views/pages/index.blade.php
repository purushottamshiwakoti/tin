...
@section('content')
    <div class="card">
        @include('backend::partials.index-header',['route_str'=>'pages'])
            ...
            <div class="dt-responsive table-responsive">
                <table id="dt-server-processing" class="table table-striped table-bordered nowrap deleteArena">
                    ...
                    <tr class="header-cols">
                        ...
                        <th data-col-name="page_title">Title</th>
                        <th data-col-name="caption">Caption</th>
                        <th data-col-name="slug">Caption</th>
