...
<head>
    ...
    <style type="text/css">
		...
		.footer p{margin: 1rem 0;font-size: 16px;}
...
<body style="width: 100%;margin:0; padding:5px 0 !important;background: #d7d7d7;" class="body" yahoo="fix" leftmargin="0" topmargin="0" marginwidth="0" marginheight="0" rightmargin="0"
      bgcolor="#ffffff">
                        ...
                        <table width="600" border="0" cellspacing="0" cellpadding="0"
                            ...
                            <tr>
                                <td align="center" valign="top" bgcolor="#ffffff">
                                    ...
                                    <table width="600" border="0" align="center" cellpadding="0" cellspacing="0" class="full">
                                        <tbody>
                                        <tr>
                                            <td align="center" height="40" valign="middle" bgcolor="#f39d1b"style="font-size:22px;font-weight:504;font-family: 'Plus Jakarta Sans', sans-serif;color:#ffffff;">
                                                <multiline>Trip cancel request acknowledge</multiline>
                                            </td>
                                        </tr>
                                        </tbody>
                                    </table>
                                    ...
                                    <table width="504" border="0" align="center" cellpadding="0" cellspacing="0" class="full">
                                        ...
                                        <tr>
                                            <td align="left" valign="top" style="font-size:16px;font-weight:400;font-family: 'Plus Jakarta Sans', sans-serif;color:#333333" class="font-replica">
                                                <multiline>Your request for cancellation of trip has been acknowledged and submitted to account teams for refund process.</multiline>
                                            </td>
                                        </tr>
                                        </tbody>
                                    </table>
                                    ...
                                    <table width="504" border="0" align="center" cellpadding="0" cellspacing="0" class="full">
                                        <tbody>
                                        <tr>
                                            <td align="left" valign="top" style="font-size:16px;font-family: 'Plus Jakarta Sans', sans-serif;color:#333333;font-weight:700;" class="font-replica">
                                                <multiline>Details of your request are outlined below: </multiline>
                                            </td>
                                        </tr>
                                        </tbody>
                                    </table>
                                    ...
                                    <table width="504" border="0" align="center" cellpadding="0" cellspacing="0" class="full">
                                        <tbody>
                                        <tr>
                                            <td align="left" valign="top" style="font-size:16px;font-family: 'Plus Jakarta Sans', sans-serif;color:#333333;line-height:25px;font-weight:400;" class="font-replica">
                                                <multiline><strong>Trip Name :</strong> {{ $booking->trip_name }}</multiline>
                                            </td>
                                        </tr>
                                        </tbody>
                                    </table>
                                    ...
                                    <table width="504" border="0" align="center" cellpadding="0" cellspacing="0" class="full">
                                        <tbody>
                                        <tr>
                                            <td align="left" valign="top" style="font-size:16px;font-family: 'Plus Jakarta Sans', sans-serif;color:#333333;line-height:25px;font-weight:700;" class="font-replica">
                                                <multiline><strong>Trip Commencement : {{ $booking->start_date->format('d/m/Y') }}</strong>
                                                    <multiline>
                                            </td>
                                        </tr>
                                        </tbody>
                                    ...
                                    <table width="504" border="0" align="center" cellpadding="0" cellspacing="0" class="full">
                                        ...
                                        <tr>
                                            <td align="left" valign="top" style="font-size:16px;font-weight:400;font-family: 'Plus Jakarta Sans', sans-serif;color:#333333;line-height:25px;" class="font-replica">
                                                <multiline><strong>Booking Reference Number: {{ $booking->id }}</strong>
                                                    <multiline>
                                            </td>
                                        </tr>
                                        </tbody>
                                    ...
                                    @foreach($booking->onlyCancelRequestedPassengers as $passenger)
                                    <table width="504" border="0" align="center" cellpadding="0" cellspacing="0" class="full">
                                        <tbody>
                                        <tr>
                                            <td align="left" valign="top" style="font-size:16px;font-weight:400;font-family: 'Plus Jakarta Sans', sans-serif;color:#333333;line-height:25px;" class="font-replica">
                                                <multiline><strong>Traveller Name :</strong> {{ $passenger->name }} </multiline>
                                            </td>
                                        </tr>
                                        </tbody>
                                    </table>
                                    ...
                                    <table width="504" border="0" align="center" cellpadding="0" cellspacing="0" class="full">
                                        ...
                                        <tr>
                                            <td align="left" valign="top" style="font-size:16px;font-weight:400;font-family: 'Plus Jakarta Sans', sans-serif;color:#333333;line-height:25px;" class="font-replica">
                                                <multiline><strong>Refund Type :</strong> Trip Cost, Airlines, Insurance
                                                    <multiline>
                                            </td>
                                        </tr>
                                        </tbody>
                                    ...
                                    <table width="504" border="0" align="center" cellpadding="0" cellspacing="0" class="full">
                                        ...
                                        <tr>
                                            <td align="left" valign="top" style="font-size:16px;font-weight:400;font-family: 'Plus Jakarta Sans', sans-serif;color:#333333;line-height:25px;" class="font-replica">
                                                <multiline><strong>Reasons:</strong> 
                                                    @foreach($booking->cancelRequests as $cancelRequest)
                                                        {{ $cancelRequest->value }}<br>
                                                    @endforeach
                                                    <multiline>
                                            </td>
                                        </tr>
