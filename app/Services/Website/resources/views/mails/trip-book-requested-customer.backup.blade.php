                                                ...
                                                <table width="270" border="0" align="left" cellpadding="0" cellspacing="0" class="full">
                                                    ...
                                                    <tr>
                                                        <td align="left" valign="top" style="font-size:16px;font-weight:400;font-family:Roboto;color:#4d5764">
                                                            <multiline>{{ setting('extras.company_name') }}</multiline>
                                                        </td>
                                                    </tr>

                                                    <tr>
                                                        <td align="left" valign="top" style="font-size:16px;font-weight:400;font-family:Roboto;color:#4d5764">
                                                            <multiline> ABN Number: - {{ setting('extras.abn_number') }} </multiline>
                                                        </td>
                                                    </tr>

                                                    <tr>
                                                        <td align="left" valign="top" style="font-size:16px;font-weight:400;font-family:Roboto;color:#4d5764">
                                                            <multiline> {!! setting('extras.company_address') !!} </multiline>
                                                        </td>
                                                    </tr>

                                                    <tr>
                                                        <td align="left" valign="top" style="font-size:16px;font-weight:400;font-family:Roboto;color:#4d5764">
                                                            <multiline> {{ setting('extras.sales_email') }} </multiline>
                                                        </td>
                                                    </tr>
                            ...
                            <tr>
                                <td align="center" valign="top" bgcolor="ffffff">
                                    ...
                                    <table width="540" border="0" align="center" cellpadding="0" cellspacing="0" class="full">
                                        <tbody>
                                        <tr>
                                            <td align="center" height="40" valign="middle" bgcolor="#f39d1b"style="font-size:22px;font-weight:540;font-family:Roboto;color:#ffffff;">
                                    ...
                                    <table width="540" border="0" align="center" cellpadding="0" cellspacing="0" class="full">
                                        ...
                                        <tr>
                                            <td align="left" valign="top" style="font-size:24px;font-weight:400;font-family:Montserrat;color:#4d5764">
                                                <multiline>Hi {{ $booking->customer->name }},</multiline>
                                            </td>
                                        </tr>
                                        </tbody>
                                    </table>
                                    ...
                                    <table width="540" border="0" align="center" cellpadding="0" cellspacing="0" class="full">
                                        ...
                                        <tr>
                                            <td align="left" valign="top" style="font-size:16px;font-weight:400;font-family:Roboto;color:#333333;line-height:24px;" class="font-replica">
                                                <multiline>You can also login to our website <a href="https://www.traveladventurenepal.com.au/">https://www.traveladventurenepal.com.au/</a> and
                                                    view your booking details and payment options. Just click on “My Booking" link on
                                                    the menu.
                                                </multiline>
                                            </td>
                                        </tr>
