                ...
                <div class="row">
                    <div class="col-12 breadcrumb-wrapper">
                        ...
                        <div class="text-content">
                            <h2 class="font-64">Regions</h2>
                            <span class="fst-italic">Regions</span>
                        </div>
                    </div>
                </div>
            </div>
                                        ...
                                        @foreach ($region as $r)
                                            ...
                                            <div class="col-md-6 mb-4 package-card-wrapper">
                                                <a href="{{ url('regions/' . $r->slug) }}" class="package-card">
                                                    <div class="img-div">
                                                        {{-- <img src="{{ asset('website/assets/img/package3.webp') }}"
                                                            alt=""> --}}
                                    ...
                                    <div class="accordion-item">
                                        ...
                                        <div id="collapseOne" class="accordion-collapse collapse show"
                                            ...
                                            <div class="accordion-body">
                                                We have a minimum age requirement of 18 years old to join the tour. Group
                                                members aged
                                                16-17 years old are welcome to join the tour but only with a family member
                                                that will act
                                                as their guardian whilst on tour. Aside from that, no age requirements at
                                                all!
                                            </div>
                                        </div>
                                    </div>
