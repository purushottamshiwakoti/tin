...
@section('content')
    ...
    <section class="mt-80 breadcrumb-section with-text bg-white bg-img short-height">
        <img src="{{ asset('website/assets/img/breadcrumb-banner-2.jpg') }}" alt="breadcrumb banner">
                        ...
                        <nav aria-label="breadcrumb">
                            <ol class="breadcrumb">
                                ...
                                <li class="breadcrumb-item active" aria-current="page"> <a
                                        href="{{ route('website.guest.wishlist') }}">Wishlist</a> </li>
                            </ol>
                        </nav>
                        <div class="text-content">
                            <h1 class="font-64">Wishlist</h1>
                        </div>
                    </div>
                </div>
            </div>
    ...
    <section class="wishlist py-60">
        <div class="container">
            <div class="col-xl-10 mx-auto">
                @guest
                    <div class="row">
                        <div class="col-xl-6 mx-auto text-center section-heading">
                ...
                <div class="row mt-60" id="wishlist">
                    ...
                    <div class="col-xl-4 col-sm-6 mb-4 package-card-wrapper" v-for="item in wishList">
                            ...
                            <div class="package-card">
                                ...
                                <div class="text-content">
                                    ...
                                    <div class="d-flex justify-content-between">
                                        <div class="price">Starting from <span>@{{ item.price }}$</span></div>
                                        <svg class="favourite added" v-bind:data-trip="item.id"
                                            v-bind:data-name="item.title" @WishlistUpdated="getAllWishList"
                                            data-url="{{ route('website.trips.favourite.store') }}" width="20"
                                            height="20" viewBox="0 0 20 20" fill="red"
                                            xmlns="http://www.w3.org/2000/svg">
