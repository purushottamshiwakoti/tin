            ...
            <div class="row">
                @if (count($trips) > 0)
                    ...
                    @foreach ($trips as $trip)
                        <div class="col-lg-4 col-md-6 package-card-wrapper">
                            <div class="package-card">
                                ...
                                <div class="text-content">
                                        ...
                                        <div class="ratings">
                                            @foreach ($trip->publishedRatings as $rating)
                                                @for ($i = 0; $i < $rating->rating_value; $i++)
                                                    <img src=" {{ public_asset('website/img/star-icon.svg') }}"
                                                        alt="star">
                                                @endfor
                                            @endforeach
                                            <span>{{ $trip->ratings()->count() }}</span>
                                    ...
                                    <div class="actions d-flex">
                                        <div class="price">AUD {{ $trip->price }} </div>
                                    </div>
                                </div>
                            </div>
                        </div>
