            ...
            <div class="text-content">
                    ...
                    <div class="rating-wrapper me-3">
                        @for ($i = 0; $i < $trip->average_rating; $i++)
                            <svg xmlns="http://www.w3.org/2000/svg" class="icon icon-tabler icon-tabler-star"
                                width="16" height="16" viewBox="0 0 24 24" stroke-width="1.5" stroke="#FAA61A"
                                fill="#FAA61A" stroke-linecap="round" stroke-linejoin="round">
                ...
                <div class="d-flex justify-content-between">
                    ...
                    <svg class="favourite" data-url="{{ route('website.trips.favourite.store') }}"
                        data-name="{{ $trip->title }}" data-trip="{{ $trip->id }}" width="20" height="20"
                        ...
                        <g >
                            <path
                                ...
                                stroke="black" stroke-opacity="0.1" stroke-width="1.5" stroke-linecap="round"
