...
@section('content')
    <section class="mt-80 breadcrumb-section with-text bg-white bg-img">
        ...
        <img src="{{ asset('ruploads/' . $page->getCoverImage()) . pages_parallax() }}" alt="">
                ...
                <div class="row">
                    <div class="col-12 breadcrumb-wrapper">
                        ...
                        <div class="text-content">
                            ...
                            <span class="fst-italic">{{ $page->caption }} </span>
                        </div>
                    </div>
                </div>
            </div>
                                    ...
                                    <div class="row">
                                        ...
                                        {{-- @foreach ($destination as $d)
                                            <div class="col-md-6 mb-4 package-card-wrapper">
                                                <a href="{{ url('destinations/' . $d->slug) }}" class="package-card">
                                                    <div class="img-div">
                                        ...
                                        <div class="regions-carousel owl-carousel owl-theme">
                                            @foreach ($destination as $a)
                                                <div class="item">
                                                    <a href="{{ url('destinations/' . $a->slug) }}"
