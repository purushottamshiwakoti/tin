                ...
                <div class="row">
                    <div class="col-12 breadcrumb-wrapper">
                        ...
                        <div class="text-content">
                            ...
                            <span class="fst-italic">{{ $destination->title }}</span>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="row">
                <div class="col-md-9 content-wrapper ">
                    <div class="text-content">
                        ...
                        <div class="region-available">
                            <h3>{{ $destination->title }} Packages</h3>
                                                    ...
                                                    <div class="text-content">
                                                        ...
                                                        <div class="info d-flex align-items-center">
                                                            ...
                                                            <div class="d-flex align-items-center">
                                                                ...
                                                                <span
                                                                    class="ml-1">{{ $t->duration ?? 'No duration found' }}</span>
                                                            </div>
                                                        </div>
                                                        <div class="d-flex justify-content-between">
                                                            <div class="price">Starting from
                                                                <span>${{ $t->price ?? 'No price found' }}</span>
                                                            </div>
                                ...
                                <div class="container p-0">
                                    <div class="row">
                                        ...
                                        @foreach ($activities as $a)
                                            <div class="col-md-6 mb-4 package-card-wrapper">
                                                <a href="{{ url('/activities/' . $a->slug) }}" class="package-card">
                                                    <div class="img-div">
                                                        {{-- <img src="assets/img/package3.webp" alt=""> --}}
                                                        @if (is_array($a->gallery) && count($a->gallery) > 0)
                                                    ...
                                                    <div class="text-content">
                                                        ...
                                                        <div class="info d-flex align-items-center">
                                                            ...
                                                            <div class="d-flex align-items-center">
                                                                ...
                                                                <span
                                                                    class="ml-1">{{ $a->duration ?? 'No duration available' }}</span>
                                                            </div>
                                                        </div>
                                                        <div class="d-flex justify-content-between">
                                                            <div class="price">Starting from
                                                                <span>${{ $a->price ?? 'No price found' }}</span>
                                                            </div>
                                                            <svg width="20" height="20" viewBox="0 0 20 20"
                                                                fill="none" xmlns="http://www.w3.org/2000/svg">
                                                                <g clip-path="url(#clip0_236_1631)">
                                ...
                                <div class="container p-0">
                                    <div class="row">
                                        ...
                                        @foreach ($regions as $r)
                                            <div class="col-md-6 mb-4 package-card-wrapper">
                                                <a href="{{ url('/regions/' . $r->slug) }}" class="package-card">
                                                    <div class="img-div">
                                                        {{-- <img src="assets/img/package3.webp" alt=""> --}}
                                                        @if (is_array($r->gallery) && count($r->gallery) > 0)
                                                    ...
                                                    <div class="text-content">
                                                        ...
                                                        <div class="info d-flex align-items-center">
                                                            ...
                                                            <div class="d-flex align-items-center">
                                                                ...
                                                                <span
                                                                    class="ml-1">{{ $a->duration ?? 'No duration found' }}</span>
                                                            </div>
                                                        </div>
                                                        <div class="d-flex justify-content-between">
                                                            <div class="price">Starting from
                                                                <span>${{ $r->price ?? 'No price found' }}</span>
                                                            </div>
                                                            <svg width="20" height="20" viewBox="0 0 20 20"
                                                                fill="none" xmlns="http://www.w3.org/2000/svg">
                                                                <g clip-path="url(#clip0_236_1631)">
                ...
                {{-- <div class="col-md-3 blog-sidebar">
                    <div class="side-container mb-4">
                        <p>Quick Links</p>
                        <ul>
                            @foreach ($listRegions as $a)
                                <li><a href="{{ route('website.regions.detail', $a->slug) }}">{{ $a->title }}</a>
                                </li>
                            @endforeach --}}
                {{-- <li><a href="#">Trekking</a></li>
                            <li><a href="#">Updates</a></li>
                            <li><a href="#">Festivals & cultures</a></li>
                            <li><a href="#">Trekking</a></li>
                            <li><a href="#">Updates</a></li>
                            <li><a href="#">Festivals & cultures</a></li> --}}
                {{-- </ul>
