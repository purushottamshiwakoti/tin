    ...
    <section class="package-listings bg-white search-page pt-40">
        <div class="container">
            <nav aria-label="breadcrumb">
                <ol class="breadcrumb dark-circled">
            ...
            <div class="row align-items-center search-bar-wrapper">
                ...
                <form class="col-md-7 mx-auto search-bar" action="{{ route('website.trips.search') }}">
                    ...
                    <button class="btn btn-primary">
                        <svg width="24" height="24" viewBox="0 0 24 24" fill="none"
                            ...
                            <path d="M21 21L15 15" stroke="white" stroke-width="1.5" stroke-linecap="round"
                                stroke-linejoin="round"></path>
                        </svg>
                    </button>
                </form>
                <div class="col-12 info text-center mt-32 mb-40">
                </div>
                @include('website::partials.filters')
                                ...
                                <div class="text-content">
                                    <div class="tags">
                                        <ul>
                                            @foreach ($trip->travelStyles as $style)
                                                <li><a
                                                        href="http://tan.com/tan/public/pages/trips?style={{ $style->slug }}">{{ $style->title }}</a>
                                                </li>
                                            @endforeach
                                        </ul>
                                    </div>
                                    ...
                                    <div class="info d-flex justify-content-between">
                                        ...
                                        <div class="activities">
                                            ...
                                            <a
                                                href="{{ route('website.activities.detail', $trip->activite->slug) }}">{{ $trip->activite->title }}</a>
                                        </div>
                                    </div>
